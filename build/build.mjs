...
import { stripIndex } from "../utils/text.js";
...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="/assets/favicon-32.png?v=231" />
  ...
  <link rel="stylesheet" href="/styles.css?v=231" />
  <link rel="stylesheet" href="/pages.css?v=231" />
  <!-- The one script these pages carry: the same wheel glide as the rest of
       the site. Everything else stays static on purpose. -->
  <script type="module" src="/js/smooth-scroll.js?v=231"></script>${headExtras({
...
<body class="page item-page">
  ...
  <header class="item-page-bar">
    <a class="site-logo" href="/">
      <img class="site-logo-mark" src="/assets/monogram-96.webp?v=231" alt="" width="40" height="40" />
    ...
    <div class="footer-grid footer-grid-3">
      <div class="footer-brand">
        <a class="footer-logo" href="/">
          <img src="/assets/monogram-96.webp?v=231" alt="" width="44" height="44" />
...
for (const [key, rawValue] of Object.entries(content.homeCopy ?? {})) {
  if (typeof rawValue !== "string" || !rawValue.trim()) continue;
  if (!HOME_COPY_KEYS.has(key)) continue;
  // Section labels are not numbered — same rule the browser applies.
  const value = key.endsWith("Eyebrow") ? stripIndex(rawValue) : rawValue;
  homeHtml = homeHtml.replace(
