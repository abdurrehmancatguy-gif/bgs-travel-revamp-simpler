...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="/assets/favicon-32.png?v=218" />
  ...
  <link rel="stylesheet" href="/styles.css?v=218" />
  <link rel="stylesheet" href="/pages.css?v=218" />
  <!-- The one script these pages carry: the same wheel glide as the rest of
       the site. Everything else stays static on purpose. -->
  <script type="module" src="/js/smooth-scroll.js?v=218"></script>${headExtras({
...
<body class="page item-page">
  ...
  <header class="item-page-bar">
    <a class="site-logo" href="/">
      <img class="site-logo-mark" src="/assets/monogram-96.webp?v=218" alt="" width="40" height="40" />
