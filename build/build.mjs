...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="/assets/favicon-32.png?v=230" />
...
<body class="page item-page">
  ...
  <header class="item-page-bar">
    <a class="site-logo" href="/">
      <img class="site-logo-mark" src="/assets/monogram-96.webp?v=230" alt="" width="40" height="40" />
    ...
    <div class="footer-grid footer-grid-3">
      <div class="footer-brand">
        <a class="footer-logo" href="/">
          <img src="/assets/monogram-96.webp?v=230" alt="" width="44" height="44" />
