import { fullSrc } from "../utils/images.js?v=215";
import { icon } from "../data/icons.js?v=215";
import { priceLabel, priceFacts } from "../data/packages.js?v=215";
import { openWhatsApp, buildWhatsAppItemUrl } from "../utils/whatsapp.js?v=215";
